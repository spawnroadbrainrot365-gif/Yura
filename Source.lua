...
Themes = {
    Darker = {
        ["Color Hub 1"] = ColorSequence.new({
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(31, 14, 255)),
            ColorSequenceKeypoint.new(0.50, Color3.fromRGB(12, 0, 166)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(31, 14, 255)),
        }),
        ["Color Hub 2"] = Color3.fromRGB(18, 0, 255),
        ["Color Stroke"] = Color3.fromRGB(31, 14, 255),
        ["Color Theme"] = Color3.fromRGB(15, 15, 15),
        ["Color Text"] = Color3.fromRGB(255, 255, 255),
        ["Color Dark Text"] = Color3.fromRGB(7, 1, 92)
    },
    Dark = {  
            ["Color Hub 1"] = ColorSequence.new({
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(31, 14, 255)),
...
local WindowBackground = Create("ImageLabel", MainFrame, {
    ...
    BackgroundTransparency = 1,
    Image = "rbxthumb://type=Asset&id=79910400591234&w=420&h=420", 
